...
# Init Alpaca API 
# api = alpaca_trade_api.REST('ALPACA_API_KEY_ID', 'ALPACA_API_KEY_SECRET', base_url='https://paper-api.alpaca.markets')  # Use paper trading endpoint for testing
api = alpaca_trade_api.REST('PKQT7VYXEZ5F540Q171B', 'pIxVNiOVpkxyTvU3hZTF5blucCRLxCILMSr9eI4q', base_url='https://paper-api.alpaca.markets')  # Use paper trading endpoint for testing
